...
import { X, Check, ShieldCheck, Ruler, Box, MessageCircle, ShoppingBag, ChevronRight, Star, ArrowRight } from 'lucide-react';
...
const CostumeDetailModal: React.FC<CostumeDetailModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Modal Container */}
      <div className="relative bg-white rounded-3xl w-full max-w-5xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-300 border border-white/20">
        ...
        <div className="w-full md:w-[45%] bg-slate-50 p-4 md:p-6 flex flex-col shrink-0 relative">
           ...
           <div className="absolute top-6 left-6 z-10 flex flex-col gap-2 items-start pointer-events-none">
              ...
              {costume.availableStock <= 5 && costume.availableStock > 0 && (
           ...
           {/* Main Image View - Adjusted for mobile height */}
           <div 
           ...
           >
              <img 
                ...
                alt={costume.name} 
                className={`w-full h-full object-cover object-top transition-transform duration-700 ease-out ${isZoomed ? 'scale-110' : 'scale-100'}`}
              />
           </div>
        ...
        {/* Changed h-full to flex-1 and min-h-0 to fix flex overflow issue on mobile */}
        <div className="w-full md:w-[55%] flex flex-col flex-1 md:h-full bg-white overflow-y-auto custom-scrollbar min-h-0 relative">
          <div className="p-6 md:p-8 flex-1">
             ...
             <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2">
                   <span className="text-2xl md:text-3xl font-bold text-red-700">Rp {costume.price.toLocaleString('id-ID')}</span>
          ...
          <div className="p-4 md:p-6 bg-white border-t border-slate-100 sticky bottom-0 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] shrink-0">
             <div className="flex gap-3">
                ...
                <button 
                  ...
                  disabled={isInCart || costume.availableStock === 0}
