...
// Customer Acquisition Components
...
const CustomerApp: React.FC = () => {
  ...
  const getViewFromPath = useCallback((pathname: string): ViewState => {
    return PATH_TO_VIEW[pathname] || 'HOME';
  }, []);

  const [view, setViewState] = useState<ViewState>(() => getViewFromPath(location.pathname));
  ...
  return (
    ...
    <HelmetProvider>
      <div className="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-900 selection:bg-red-200 selection:text-red-900">
        ...
        <PromoBanner openWhatsApp={openWhatsApp} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/kostume_fadilyss/" target="_blank" rel="noopener noreferrer" aria-label="Instagram KostumFadilyss" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-red-600 hover:text-white transition-all"><Instagram size={20} /></a>
                  <a href="https://wa.me/62895428282092" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp KostumFadilyss" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-[#25D366] hover:text-white transition-all">
        ...
        <WhatsAppFloating isCartOpen={isCartOpen} />

        {/* First Visit Popup */}
        <FirstVisitPopup openWhatsApp={openWhatsApp} />
