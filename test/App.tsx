...
import { ShoppingBag, Menu, X, CheckCircle, Search, MapPin, Phone, Instagram, Facebook, MessageCircle, RotateCcw, Star, Shield, ShieldCheck, Calendar, Award, Truck, ArrowRight, ChevronDown, Ruler, Users, Sparkles, Quote, Scissors, Zap, Clock, Play, Check, Mail, Twitter, Youtube, CreditCard, ChevronRight, User as UserIcon, LogOut, LogIn, AlertCircle, History, Lock } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleRentAgainFromHistory = (items: CartItem[]) => {
      // Logic to merge history items into current cart
      setCart(prev => {
          const newCart = [...prev];
      ...
      setActiveUserModal(null); // Close History Modal
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-900 selection:bg-red-200 selection:text-red-900">
      ...
      <main className="flex-1">
        <AnimatePresence mode="wait">
              ...
              <section className="relative min-h-[92vh] flex items-center bg-slate-950 overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10 pt-10 pb-10">
                   <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                      ...
                      >
                         ...
                         <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                            <button 
                               ...
                               className="px-8 py-5 bg-white text-slate-950 font-bold text-lg rounded-none hover:bg-slate-200 transition-all flex items-center justify-center gap-3 group relative overflow-hidden"
                            >
                            ...
                            <button 
                               ...
                               className="px-8 py-5 border border-slate-700 text-white font-medium text-lg hover:border-white hover:bg-white/5 transition-all"
                            >
                               Jadwalkan Fitting
                            </button>
                         </div>
                      ...
                      >
                         {/* Main Large Image */}
                         <div className="absolute right-0 top-0 bottom-0 w-[85%] bg-slate-800 overflow-hidden shadow-2xl shadow-black/50 border border-slate-800 z-10 group">
                            <img 
                         ...
                         <motion.div 
                            ...
                            className="absolute left-0 bottom-12 w-[45%] aspect-[3/4] bg-slate-900 border-4 border-slate-950 shadow-2xl z-20 overflow-hidden group"
                         >
                            <img 
                               src="https://images.unsplash.com/photo-1611024847487-e26177381a3f?q=80&w=600&auto=format&fit=crop" 
                         ...
                         <motion.div 
                            ...
                            className="absolute -right-4 top-12 bg-white/10 backdrop-blur-md border border-white/20 p-6 shadow-xl z-30 max-w-[180px]"
                         >
                            ...
                            <p className="text-slate-300 text-xs leading-tight">Sekolah telah mempercayakan seragam mereka.</p>
                         </motion.div>
              ...
              <section className="py-24 bg-white">
                <div className="container mx-auto px-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                     {[
                        { title: 'Satuan Putra', img: 'https://images.unsplash.com/photo-1542204165-65bf26472b9b?q=80&w=800&auto=format&fit=crop', cat: 'pria' },
                        { title: 'Satuan Putri', img: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=800&auto=format&fit=crop', cat: 'wanita' },
                        { title: 'Atribut Lengkap', img: 'https://images.unsplash.com/photo-1611024847487-e26177381a3f?q=80&w=800&auto=format&fit=crop', cat: 'aksesoris' }
                     ].map((item, idx) => (
                        <motion.div 
                          key={idx}
                          ...
                          className="group relative h-[400px] md:h-[500px] rounded-3xl overflow-hidden cursor-pointer shadow-sm hover:shadow-2xl transition-all duration-500"
                    ...
                    <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
                       {[
                          ...
                          <ScrollReveal key={i} delay={i * 0.1}>
                             <div className="bg-white p-6 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-xl transition-all duration-300 group h-full">
                                <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center text-slate-900 mb-4 group-hover:bg-red-600 group-hover:text-white transition-colors duration-300">
                ...
                <div className="flex w-full overflow-hidden pb-4">
                   <div className="flex gap-6 animate-marquee min-w-full pl-6">
                      {[...TESTIMONIALS, ...TESTIMONIALS].map((review, i) => (
                         <div key={i} className="w-80 md:w-96 p-6 rounded-2xl bg-white border border-slate-100 shrink-0 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group/card cursor-default relative">
                  ...
                  <div className="container mx-auto px-4">
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 rounded-3xl overflow-hidden shadow-2xl bg-white border border-slate-200">
                        ...
                        <div className="lg:col-span-2 h-[400px] lg:h-auto min-h-[400px] relative bg-slate-100">
                           <iframe 
                             src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.666427009761!2d106.82496477499014!3d-6.175392393811975!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2e764b12d%3A0x3d2ad6e1e039bcc8!2sMonumen%20Nasional!5e0!3m2!1sid!2sid!4v1708420000000!5m2!1sid!2sid" 
                             width="100%" 
                             height="100%" 
                             style={{border:0}} 
                             allowFullScreen 
                ...
                <div className="container mx-auto px-4 py-4 space-y-4 md:space-y-0 md:flex items-center justify-between gap-4">
                  ...
                  <div className="relative flex-1 max-w-lg">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-100 border-none rounded-xl focus:ring-2 focus:ring-red-500 focus:bg-white transition-all outline-none"
                    />
                  </div>
          ...
          {view === 'SUCCESS' && lastBooking && (
            ...
            >
              <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl text-center max-w-md w-full border border-white/50 relative overflow-hidden">
                ...
                <div className="space-y-3">
                  <button 
                    ...
                    className="w-full py-3.5 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-green-600/20"
                  >
                    <Phone size={18} /> Konfirmasi via WhatsApp
                  </button>
                  <button 
                    onClick={handleRentAgain}
                    className="w-full py-3.5 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors"
                  >
      ...
      {!isCartOpen && (
        <button
          ...
          className="fixed bottom-6 left-6 z-40 bg-[#25D366] hover:bg-[#20bd5a] text-white p-4 rounded-full shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 group"
        ...
        {isLogoutConfirmOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
               ...
               <p className="text-slate-500 mb-6">Apakah Anda yakin ingin keluar dari akun? Keranjang belanja Anda mungkin akan dikosongkan.</p>
               ...
               <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    className="flex-1 py-2.5 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-colors shadow-lg shadow-red-500/30"
                  >
                    Ya, Keluar
                  </button>
               </div>
